...
Describe "Update-XsTmanData function for $moduleName" -Tags Build {
    It "Should Return false when -WhatIf is used." {
        Update-XsTmanData -RestServer localhost -Status 4 -TmanId 1 -WhatIf | Should be $false
    }
    It "Should return 1 when the logfile is not specified." {
        ...
        Update-XsTmanData -RestServer localhost -Status 4 -TmanId 1 | Should be 1
    ...
    It "Should return 1." {
        ...
        Update-XsTmanData -RestServer localhost -Status 4 -TmanId 1 -TmanLogFile "c:\test\test.log" | Should be 1
        Assert-MockCalled -CommandName 'Get-XsTimeStamp' -Times 1 -Exactly -Scope It
        Assert-MockCalled -CommandName 'Write-Log' -Times 1 -Exactly -Scope It
        Assert-MockCalled -CommandName 'Invoke-XesterRestCall' -Times 1 -Exactly -Scope It
    }
    It "Should throw when Invoke-XesterRestCall Fails." {
        ...
        {Update-XsTmanData -RestServer localhost -Status 4 -TmanId 1 -TmanLogFile "c:\test\test.log"} | Should Throw
        Assert-MockCalled -CommandName 'Get-XsTimeStamp' -Times 1 -Exactly -Scope It
        Assert-MockCalled -CommandName 'Write-Log' -Times 1 -Exactly -Scope It
        Assert-MockCalled -CommandName 'Invoke-XesterRestCall' -Times 1 -Exactly -Scope It
    }
    It "Should not throw when Invoke-XesterRestCall succeeds." {
        ...
        {Update-XsTmanData -RestServer localhost -Status 4 -TmanId 1 -TmanLogFile "c:\test\test.log"} | Should not Throw
        Assert-MockCalled -CommandName 'Get-XsTimeStamp' -Times 1 -Exactly -Scope It
        Assert-MockCalled -CommandName 'Write-Log' -Times 1 -Exactly -Scope It
        Assert-MockCalled -CommandName 'Invoke-XesterRestCall' -Times 1 -Exactly -Scope It
    }
